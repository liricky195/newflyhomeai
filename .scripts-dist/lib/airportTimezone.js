...
exports.getAirportTimezone = getAirportTimezone;
exports.gmtOffsetLabelForAirport = gmtOffsetLabelForAirport;
exports.formatInAirportTz = formatInAirportTz;
exports.isoToLocalHHMM = isoToLocalHHMM;
/**
...
function getAirportTimezone(iata) {
    var _a;
    return (_a = AIRPORT_TIMEZONE[iata.toUpperCase()]) !== null && _a !== void 0 ? _a : "UTC";
}
/**
 * Returns the airport's current GMT offset label, e.g. "GMT+4" or "GMT+5:30".
 * Computed via Intl so DST is respected automatically.
 */
function gmtOffsetLabelForAirport(iata) {
    var _a, _b;
    var tz = getAirportTimezone(iata);
    try {
        var parts = new Intl.DateTimeFormat("en-GB", {
            timeZone: tz,
            timeZoneName: "shortOffset",
        }).formatToParts(new Date());
        var raw = (_b = (_a = parts.find(function (p) { return p.type === "timeZoneName"; })) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : "GMT";
 ...
 */
function formatInAirportTz(unixSeconds, iata, options) {
    var tz = getAirportTimezone(iata);
    return new Intl.DateTimeFormat("en-US", __assign(__assign({}, options), { timeZone: tz })).format(new Date(unixSeconds * 1000));
}
/**
...
function isoToLocalHHMM(isoString) {
    var m = isoString.match(/T(\d{2}:\d{2})/);
